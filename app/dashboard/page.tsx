    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;font-family:'Inter',-apple-system,sans-serif;}
        ...
        .r-bnav-item{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:3px;
          flex:1;padding:6px 4px;text-decoration:none;color:rgba(255,255,255,0.38);
          font-size:10px;font-weight:500;transition:all 0.18s;border:none;background:none;cursor:pointer;}
        ...
        @media(max-width:1023px){
          ...
          .r-main{margin-left:0!important;padding-bottom:74px;}
