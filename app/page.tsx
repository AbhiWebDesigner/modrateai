...
import { Zap, Globe, BarChart3, Bell, MessageSquare, Check, ChevronRight, Star, AlertTriangle, Shield } from 'lucide-react';
  ...
  return (
    <main style={{ fontFamily: "'Inter', 'Segoe UI', sans-serif" }} className="min-h-screen text-white"
      ...
      <nav className="nav-bg fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-8 py-4">
        <Link href="/">
          <Image src="/logo.svg" alt="ModrateAI" width={140} height={35} priority />
        </Link>
      ...
      <footer style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }} className="px-8 py-6 flex flex-wrap items-center justify-between gap-4">
        <Link href="/">
          <Image src="/logo.svg" alt="ModrateAI" width={120} height={30} />
        </Link>
        <div className="flex gap-6">
          ...
          <a href="mailto:dabrram330@gmail.com" className="text-sm text-gray-600 hover:text-gray-400 transition-colors">Contact</a>
        </div>
