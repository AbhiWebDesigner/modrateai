...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      "Unlimited live stream moderation (manual select, quota based)",
      "Bad / toxic / spam → hide for review",
      "Review queue",
  ...
  },
  {
    ...
    btnStyle: { background: "rgba(124,58,237,0.10)", color: "rgba(255,255,255,0.25)" } as React.CSSProperties,
    ...
    lockedFeatures: [
      ...
      "Unlimited live streams moderation",
      "Bad / toxic / spam → hide for review",
